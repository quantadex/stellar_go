...
[Prebuilt binaries](https://github.com/quantadex/stellar_go/releases) of the federation server are available on the [releases page](https://github.com/quantadex/stellar_go/releases).
...
```
go get -u github.com/quantadex/stellar_go/services/federation
```
