...
1. Clone horizon's source:  `go get github.com/stellar/go && cd $GOPATH/src/github.com/quantadex/stellar_go/`
2. Under the project folder, download external dependencies: `glide install`
3. Build the binary: `go install github.com/quantadex/stellar_go/services/horizon`
