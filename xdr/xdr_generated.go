...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s MatchedOrder) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *MatchedOrder) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*MatchedOrder)(nil)
	_ encoding.BinaryUnmarshaler = (*MatchedOrder)(nil)
)
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s SettlementOp) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *SettlementOp) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*SettlementOp)(nil)
	_ encoding.BinaryUnmarshaler = (*SettlementOp)(nil)
)
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s SettlementResultCode) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *SettlementResultCode) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*SettlementResultCode)(nil)
	_ encoding.BinaryUnmarshaler = (*SettlementResultCode)(nil)
)
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s SettlementResult) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *SettlementResult) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*SettlementResult)(nil)
	_ encoding.BinaryUnmarshaler = (*SettlementResult)(nil)
)
